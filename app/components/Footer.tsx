    ...
    <footer id="contact" className="border-t border-line">
      <div className="mx-auto max-w-6xl px-6 py-20 sm:px-10 sm:py-28">
        <div className="grid gap-12 sm:grid-cols-2 sm:gap-20">
          <div>
            <p className="font-serif text-3xl leading-[1.15] sm:text-5xl sm:leading-[1.1]">
              ...
              <br className="hidden sm:block" /> the product question is the
              hard part?
            </p>
        ...
        <div className="mt-16 flex flex-wrap items-center justify-between gap-4 border-t border-line pt-6">
          ...
          <div className="flex gap-6 font-mono text-[11px] uppercase tracking-[0.1em] text-faint">
            <Link href="/privacy" className="pressable link-underline">
              Privacy
            </Link>
            <Link href="/terms" className="pressable link-underline">
              Terms
            </Link>
          </div>
        </div>
